    ...
    webim.initialize = function (settings, callback) {
        ...
        this.ChatConversationListView = Backbone.View.extend({
        	...
        	render: function () {
        		var html="";
        		for(var i=0;i<10;i++){
        			html+=webim.templates.chat_conversation_list_item();
        		}
            	this.$el.html(html);
                return this;
            }
        ...
        this.ChatLeftPanelListView = Backbone.View.extend({
            ...
            initialize: function () {
            	this.chatConversationListView = new webim.ChatConversationListView();
        ...
        this.ChatMessageMainPanelView =  Backbone.View.extend({
        	...
        	render:function(){
        		this.$el.html(webim.templates.chat_message_main_panel());
        		return this;
        	}
        });
        ...
        this.ChatMessageContainerView = Backbone.View.extend({
        	...
        	render:function(){
        		...
        		$(".chatContainer",this.el).append(this.chatMessageMainPanelView.render().el);
        		return this;
        	}
        ...
        this.initConnection = function () {
            ...
            if (this.connection && this.connection.connected) {
                ...
                this.setUpXMLLogging();
                this.connection.connect("wuhao002", "Aa123456", this.onConnect);
