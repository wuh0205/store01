...
public   class  ClientKeepAliveFilter  extends  KeepAliveFilter {  
    ...
    public  ClientKeepAliveFilter(KeepAliveMessageFactory messageFactory) {  
        super (messageFactory, IdleStatus.BOTH_IDLE,  new  ExceptionHandler(), INTERVAL, TIMEOUT);  
    }  
      
    public  ClientKeepAliveFilter() {  
        super ( new  ClientKeepAliveMessageFactoryImpl(), IdleStatus.BOTH_IDLE,  new  ClientExceptionHandler(), INTERVAL, TIMEOUT);  
 ...
 *  
 */   
class  ClientKeepAliveMessageFactoryImpl  implements  KeepAliveMessageFactory {  
	...
	public Object getRequest(IoSession session) {
		System.out.println("客户端==返回一个（新）保活请求消息");
	...
	public Object getResponse(IoSession session, Object request) {
		System.out.println("客户端==返回一个（新）为指定的保活请求响应消息");
	...
	public boolean isRequest(IoSession session, Object message) {
		...
		realMessage.rewind();
		System.out.println("客户端==指定的消息是否是保持请求消息："+result);
		return result;
	}
	...
	public boolean isResponse(IoSession session, Object message) {
		...
		realMessage.rewind();
		System.out.println("客户端==如果指定的消息是否是一个保活响应消息"+result);
		return result;
	}   
}  
